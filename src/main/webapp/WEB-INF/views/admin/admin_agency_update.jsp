	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-xs-8 col-md-8 col-lg-8 content-wrap">
				...
				<form action="<c:url value='/admin/comUpdate' />"
					name="comUpdateForm" id="comUpdateForm" method="post">
					<table class="table">
						<tbody class="t-control">
							...
							<tr>
								...
								<td><input class="form-control input-sm" id="comName"
									name="comName" value="${comDetail.comName}">
									<div class="text-right">
										<span id="msgName">*중복확인을 진행하세요</span>
										<button type="button" class="btn btn-primary"
											id="nameCheckBtn">이름중복체크</button>
									</div>
								<!--자바스크립트에서 추가--></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input class="form-control input-sm" type="text"
									id="comAddress" name="comAddress" value="${comDetail.comAddress}">
									<div class="text-right">
										<input type="button" class="btn btn-primary"
											onclick="kakaoMap()" value="주소 검색"> <br>
									</div>
									<div id="map"
										style="width: 100%; height: 300px; margin-top: 10px;"></div></td>
							</tr>
						</tbody>
					</table>
				...
				<div class="com-update-btn-wrap text-right">
					...
					<button type="button" class="btn btn-dark" id="comListBtn"
